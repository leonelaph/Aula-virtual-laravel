    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <h2 class="card-title mb-0">Editar Aula</h2>
            </div>
        </div>
        <div class="card-content">
            <form action="{{ route('aulas.update', $aula) }}" method="POST" class="form-container">
                @csrf
                @method('PUT')
                ...
                <div class="form-actions">
                    <a href="{{ route('aulas.show', $aula) }}" class="btn btn-info">
